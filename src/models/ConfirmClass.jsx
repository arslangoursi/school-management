        ...
        <div className="model__content">
          ...
          <div className="wraper__outside">
            <div className="signal__input__entry__wraper">
              ...
              <div className="signal__input__entry__wraper__confclass">
                2300
              </div>
              <div className="signal__input__entry__wraper__confclass">5</div>
              <div className="signal__input__entry__wraper__svg__extra">
                <svg
                  width="11"
                  height="10"
                  viewBox="0 0 11 10"
          ...
          <div className="add__school__button">
            <NavLink className="add__school__button__entry" to="/dashboard">
