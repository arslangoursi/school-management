...
export default function ChangeClassFee({ onClose }) {
  return (
    <>
      <div className="model__container">
        <div className="model__content">
          <div className="signal__input__entry__wraper__svg" onClick={onClose}>
            <div className="Change__class__heading">Change Classes Fee </div>
          ...
          <div className="extra__fund">
            <div className="extra__fund__entry">
              <div className="extra__fund__entry__title">One</div>
              <input
                className="extra__fund__entry__input"
                type="number"
                placeholder="Fund Amount"
              />
            </div>
            <div className="extra__fund__entry">
              <div className="extra__fund__entry__title">Two</div>
              <input
                className="extra__fund__entry__input"
                type="number"
                placeholder="Fund Amount"
            ...
            <div className="extra__fund__entry">
              <div className="extra__fund__entry__title">Three</div>
              <input
                className="extra__fund__entry__input"
                type="text"
                placeholder="Fund Amount"
          ...
          <div className="add__school__button">
            <button className="add__school__button__entry">
              <div className="add__school__button__entry__text">
                Save Changes
              </div>
            </button>
          </div>
