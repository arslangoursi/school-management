...
export default function FinancialsPaytostaff() {
  return (
    <>
      {" "}
      <div className="dashboard__heading">
        <div className="dashboard__logo">
          ...
          <div className="dashboard__title">Financials {">"} Pay to Staff</div>
        </div>
      </div>
      <div className="FinancialsPaytostaff__content__all__main">
        <div className="FinancialsPaytostaff__content">
          <div className="FinancialsPaytostaff__content__all">
            <div className="FinancialsPaytostaff__content__all__title">
              Fill out the following to pay to Staff
            </div>
            <button className="FinancialsPaytostaff__content__all__button">
              Pay Now
            </button>
          </div>
        </div>
        <div className="FinancialsPaytostaff__content__all__checkbox">
          <div className="FinancialsPaytostaff__content__all__checkbox">
            <input type="checkbox" />
            <div className="FinancialsPaytostaff__content__all__checkbox__title">
              Admin
            </div>
          </div>
          <div className="FinancialsPaytostaff__content__all__checkbox">
        ...
        <div className="container__main__content__listing__table__finacespay">
